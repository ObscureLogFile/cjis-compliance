...
This control document defines how `[[AGENCY_NAME]]` implements **SC-30 — Sc-30** for systems, personnel, services, and data within the CJIS scope.

This control addresses sc-30 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SC-30** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SC-30.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SC-30.
