...
This control document defines how `[[AGENCY_NAME]]` implements **SR-11 — Sr-11** for systems, personnel, services, and data within the CJIS scope.

This control addresses sr-11 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SR-11** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SR-11.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SR-11.
