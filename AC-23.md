...
This control document defines how `[[AGENCY_NAME]]` implements **AC-23 — Ac-23** for systems, personnel, services, and data within the CJIS scope.

This control addresses ac-23 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **AC-23** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for AC-23.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by AC-23.
