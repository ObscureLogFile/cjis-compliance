...
This control document defines how `[[AGENCY_NAME]]` implements **SC-15 — Collaborative Computing Devices and Applications** for systems, personnel, services, and data within the CJIS scope.

This control addresses collaborative computing devices and applications for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SC-15** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SC-15.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SC-15.
...
- **Source title:** COLLABORATIVE COMPUTING DEVICES AND APPLICATIONS
...
[AC-21](../control_documents/AC-21.md)
