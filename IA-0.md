...
This control document defines how `[[AGENCY_NAME]]` implements **IA-0 — Use of Originating Agency Identifiers in Transactions and Information Exchanges** for systems, personnel, services, and data within the CJIS scope.

This control addresses use of originating agency identifiers in transactions and information exchanges for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **IA-0** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for IA-0.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by IA-0.
