...
This control document defines how `[[AGENCY_NAME]]` implements **PE-9 — Power Equipment and Cabling** for systems, personnel, services, and data within the CJIS scope.

This control addresses power equipment and cabling for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **PE-9** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for PE-9.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by PE-9.
...
- **Source title:** POWER EQUIPMENT AND CABLING
- **Source marking:** `[Priority 2]`

**Control**

> Protect power equipment and power cabling for the system from damage and destruction. Note: This control only applies to data centers as defined in Appendix A Terms and Definitions.
...
[PE-4](../control_documents/PE-4.md)
