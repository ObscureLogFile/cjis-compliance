...
This control document defines how `[[AGENCY_NAME]]` implements **SI-16 — Memory Protection** for systems, personnel, services, and data within the CJIS scope.

This control addresses si-16 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SI-16** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SI-16.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SI-16.
...
- **Source title:** MEMORY PROTECTION
...
> SI-7. SUPPLY CHAIN RISK MANAGEMENT (SR)
