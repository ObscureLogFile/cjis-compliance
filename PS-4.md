...
This control document defines how `[[AGENCY_NAME]]` implements **PS-4 — Personnel Termination** for systems, personnel, services, and data within the CJIS scope.

This control addresses personnel termination for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **PS-4** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for PS-4.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by PS-4.
...
- **Source title:** PERSONNEL TERMINATION
...
> AC-2, IA-4, PE-2, PS-6, PS-7.

## Related controls

[AC-2](../control_documents/AC-2.md), [IA-4](../control_documents/IA-4.md), [PE-2](../control_documents/PE-2.md), [PS-6](../control_documents/PS-6.md), [PS-7](../control_documents/PS-7.md)
