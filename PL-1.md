...
This control document defines how `[[AGENCY_NAME]]` implements **PL-1 — Policy and Procedures** for systems, personnel, services, and data within the CJIS scope.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **PL-1** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for PL-1.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by PL-1.
