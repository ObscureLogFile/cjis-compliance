...
This control document defines how `[[AGENCY_NAME]]` implements **RA-8 — Ra-8** for systems, personnel, services, and data within the CJIS scope.

This control addresses ra-8 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **RA-8** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for RA-8.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by RA-8.
