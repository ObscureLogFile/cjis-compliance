...
This control document defines how `[[AGENCY_NAME]]` implements **IR-7(1) — Automation Support for Availability of Information and Support10f** for systems, personnel, services, and data within the CJIS scope.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **IR-7(1)** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.

**Procedure**

1. Confirm that parent control IR-7 is operating and identify the enhancement condition.
...
4. Update the IR-7 evidence set and escalate any gap or exception.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for IR-7(1).
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by IR-7(1).
...
- **Source title:** INCIDENT RESPONSE ASSISTANCE | AUTOMATION SUPPORT FOR AVAILABILITY OF INFORMATION AND SUPPORT10F
...
[IR-7](../control_documents/IR-7.md)
