...
This control document defines how `[[AGENCY_NAME]]` implements **SI-10 — Information Input Validation** for systems, personnel, services, and data within the CJIS scope.

This control addresses information input validation for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SI-10** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SI-10.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SI-10.
...
- **Source title:** INFORMATION INPUT VALIDATION
