...
This control document defines how `[[AGENCY_NAME]]` implements **CM-9 — Configuration Management Plan** for systems, personnel, services, and data within the CJIS scope.

This control addresses configuration management plan for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **CM-9** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for CM-9.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by CM-9.
...
- **Source title:** CONFIGURATION MANAGEMENT PLAN
...
> CM-2, CM-3, CM-4, CM-5, CM-8, PL-2, SA-10, SI-12.

## Related controls

[CM-2](../control_documents/CM-2.md), [CM-3](../control_documents/CM-3.md), [CM-4](../control_documents/CM-4.md), [CM-5](../control_documents/CM-5.md), [CM-8](../control_documents/CM-8.md), [PL-2](../control_documents/PL-2.md), [SA-10](../control_documents/SA-10.md), [SI-12](../control_documents/SI-12.md)
