...
This control document defines how `[[AGENCY_NAME]]` implements **AC-3(14) — Individual Access** for systems, personnel, services, and data within the CJIS scope.

Enhancement to AC-3 (Access Enforcement) that strengthens, automates, or narrows the base requirement.

**Implementation objective:** Implement this enhancement after the base control is stable. Apply the specific individual access requirement and verify it through testing, review, or monitoring.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **AC-3(14)** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.

**Procedure**

1. Confirm that parent control AC-3 is operating and identify the enhancement condition.
...
4. Update the AC-3 evidence set and escalate any gap or exception.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for AC-3(14).
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by AC-3(14).
...
- **Source title:** ACCESS ENFORCEMENT | INDIVIDUAL ACCESS
...
[AC-3](../control_documents/AC-3.md), [IA-8](../control_documents/IA-8.md)
