...
This control document defines how `[[AGENCY_NAME]]` implements **IA-6 — Authentication Feedback** for systems, personnel, services, and data within the CJIS scope.

This control addresses authentication feedback for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **IA-6** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for IA-6.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by IA-6.
...
[AC-3](../control_documents/AC-3.md)
