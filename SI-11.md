...
This control document defines how `[[AGENCY_NAME]]` implements **SI-11 — Error Handling** for systems, personnel, services, and data within the CJIS scope.

This control addresses error handling for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SI-11** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SI-11.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SI-11.
...
[AU-2](../control_documents/AU-2.md), [AU-3](../control_documents/AU-3.md), [SI-2](../control_documents/SI-2.md)
