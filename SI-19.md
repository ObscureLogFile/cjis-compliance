...
This control document defines how `[[AGENCY_NAME]]` implements **SI-19 — De-identification** for systems, personnel, services, and data within the CJIS scope.

This control addresses si-19 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **SI-19** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for SI-19.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by SI-19.
