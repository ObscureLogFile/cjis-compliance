...
This control document defines how `[[AGENCY_NAME]]` implements **AU-16 — Au-16** for systems, personnel, services, and data within the CJIS scope.

This control addresses au-16 for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **AU-16** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for AU-16.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by AU-16.
