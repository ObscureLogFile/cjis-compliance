...
This control document defines how `[[AGENCY_NAME]]` implements **IR-4(1) — Automated Incident Handling Processes** for systems, personnel, services, and data within the CJIS scope.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **IR-4(1)** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.

**Procedure**

1. Confirm that parent control IR-4 is operating and identify the enhancement condition.
...
4. Update the IR-4 evidence set and escalate any gap or exception.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for IR-4(1).
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by IR-4(1).
...
- **Source title:** INCIDENT HANDLING | AUTOMATED INCIDENT HANDLING PROCESSES
...
[IR-4](../control_documents/IR-4.md)
