...
This control document defines how `[[AGENCY_NAME]]` implements **PE-11 — Emergency Power** for systems, personnel, services, and data within the CJIS scope.

This control addresses emergency power for CJIS systems, users, or data.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **PE-11** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for PE-11.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by PE-11.
...
- **Source title:** EMERGENCY POWER
- **Source marking:** `[Priority 2]`

**Control**

> Provide an uninterruptible power supply to facilitate an orderly shutdown of the information system or transition of the information system to an alternate power source in the event of a primary power source loss. Note: This control only applies to data centers as defined in Appendix A Terms and Definitions.
...
[AT-3](../control_documents/AT-3.md), [CP-2](../control_documents/CP-2.md), [CP-7](../control_documents/CP-7.md)
