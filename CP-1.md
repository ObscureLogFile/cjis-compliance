...
This control document defines how `[[AGENCY_NAME]]` implements **CP-1 — Policy and Procedures** for systems, personnel, services, and data within the CJIS scope.

This control addresses policy and procedures for CJIS systems, users, or data.

**Implementation objective:** Keep backups, recovery procedures, and restoration testing current.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **CP-1** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for CP-1.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by CP-1.
