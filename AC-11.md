...
This control document defines how `[[AGENCY_NAME]]` implements **AC-11 — Device Lock** for systems, personnel, services, and data within the CJIS scope.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **AC-11** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for AC-11.
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by AC-11.
...
[AC-2](../control_documents/AC-2.md), [AC-7](../control_documents/AC-7.md), [IA-11](../control_documents/IA-11.md), [PL-4](../control_documents/PL-4.md)
