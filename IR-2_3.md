...
This control document defines how `[[AGENCY_NAME]]` implements **IR-2(3) — Breach** for systems, personnel, services, and data within the CJIS scope.
...
A new system, user, vendor, change, incident, assessment finding, or scheduled review places **IR-2(3)** in scope. Use the approved requirement, current system record, risk decision, and prior evidence as inputs.

**Procedure**

1. Confirm that parent control IR-2 is operating and identify the enhancement condition.
...
4. Update the IR-2 evidence set and escalate any gap or exception.
...
- [ ] Assign `[[CONTROL_OWNER]]` and a backup owner for IR-2(3).
- [ ] Confirm the systems, facilities, personnel, vendors, and data flows covered by IR-2(3).
...
- **Source title:** INCIDENT RESPONSE TRAINING | BREACH
- **Source marking:** `[Priority 3]`

**Control**

> Provide incident response training on how to identify and respond to a breach, including the organization\222s process for reporting a breach.
...
[IR-2](../control_documents/IR-2.md)
